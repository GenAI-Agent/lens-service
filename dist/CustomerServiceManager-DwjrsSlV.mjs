class c {
  ...
  static async getAllConversations() {
    try {
      const { DatabaseService: e } = await import("./index-_5fO5glf.mjs").then((a) => a.a);
  ...
  static async getConversationById(e) {
    try {
      const { DatabaseService: t } = await import("./index-_5fO5glf.mjs").then((a) => a.a);
  ...
  static async addCustomerServiceReply(e, t, a = "客服") {
    try {
      const { DatabaseService: r } = await import("./index-_5fO5glf.mjs").then((s) => s.a);
