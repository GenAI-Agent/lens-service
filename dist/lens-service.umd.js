(function(m,w){typeof exports=="object"&&typeof module<"u"?module.exports=w():typeof define=="function"&&define.amd?define(w):(m=typeof globalThis<"u"?globalThis:m||self,m.LensService=w())})(this,function(){"use strict";var N=Object.defineProperty;var Q=(m,w,C)=>w in m?N(m,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):m[w]=C;var b=(m,w,C)=>Q(m,typeof w!="symbol"?w+"":w,C);const m={container:`
  ...
  `};class w{constructor(e="33.33%",t="right"){b(this,"container");b(this,"overlay");b(this,"panel");b(this,"isOpen",!1);b(this,"width");b(this,"position");b(this,"capturedImage",null);b(this,"capturedText",null);b(this,"onSendMessage");b(this,"onSelectRule");b(this,"onClose");b(this,"onOpen");this.width=e,this.position=t,this.container=this.createContainer(),this.overlay=this.createOverlay(),this.panel=this.createPanel()}createContainer(){const e=document.createElement("div");return e.id="sm-container",e.style.cssText=m.container,e}createOverlay(){const e=document.createElement("div");return e.style.cssText=m.overlay,e.style.display="none",e.addEventListener("click",()=>this.close()),e}createPanel(){const e=document.createElement("div");return e.style.cssText=m.panel,e.style.width=this.width,this.position==="right"?(e.style.right=`-${this.width}`,e.style.left="auto"):(e.style.left=`-${this.width}`,e.style.right="auto"),e.innerHTML=`
    ...
    `,this.bindEvents(e),e}bindEvents(e){var n,i,s,r,a;(n=e.querySelector("#sm-close-btn"))==null||n.addEventListener("click",()=>{this.close()});const t=e.querySelector("#sm-send-btn");t?(console.log("✅ Send button found, binding click event"),t.addEventListener("click",c=>{console.log("🔥 Send button clicked via addEventListener!"),c.preventDefault(),c.stopPropagation(),this.handleSend()}),t.onclick=c=>{console.log("🔥 Send button clicked via onclick!"),c.preventDefault(),c.stopPropagation(),this.handleSend()},e.addEventListener("click",c=>{(c.target.id==="sm-send-btn"||c.target.closest("#sm-send-btn"))&&(console.log("🔥 Send button clicked via delegation!"),c.preventDefault(),c.stopPropagation(),this.handleSend())})):console.error("❌ Send button not found!");const o=e.querySelector("#sm-input");o?(console.log("✅ Input field found, binding events"),o.addEventListener("keypress",c=>{c.key==="Enter"&&(console.log("🔥 Enter key pressed in input"),this.handleSend())}),o.addEventListener("input",c=>{console.log("🔥 Input event:",c.target.value)}),o.addEventListener("focus",()=>{console.log("🔥 Input focused")}),o.addEventListener("blur",()=>{console.log("🔥 Input blurred")})):console.error("❌ Input field not found!"),(i=e.querySelector("#sm-chat-tab"))==null||i.addEventListener("click",()=>{this.showView("chat")}),(s=e.querySelector("#sm-refresh-btn"))==null||s.addEventListener("click",()=>{this.clearMessages()}),(r=e.querySelector("#sm-history-btn"))==null||r.addEventListener("click",()=>{this.showHistory()}),(a=e.querySelector("#sm-remove-image"))==null||a.addEventListener("click",()=>{this.clearCapturedImage()})}handleSend(){const e=this.panel.querySelector("#sm-input"),t=e.value.trim();(t||this.capturedImage)&&this.onSendMessage&&(this.onSendMessage(t,this.capturedImage||void 0,this.capturedText||void 0),e.value="",this.clearCapturedImage())}showView(e){const t=this.panel.querySelector("#sm-chat-view"),o=this.panel.querySelector("#sm-chat-tab");e==="chat"&&(t.style.display="flex",o.style.cssText=m.tabButton+"; "+m.tabButtonActive)}addMessage(e){const t=this.panel.querySelector("#sm-messages");if(!t)return;const o=document.createElement("div");if(o.style.cssText=e.role==="user"?m.userMessage:m.assistantMessage,e.role==="assistant"?o.innerHTML=e.content:o.textContent=e.content,e.sources&&e.sources.length>0){const n=document.createElement("div");n.style.cssText=m.sources,n.innerHTML="<strong>參考來源：</strong><br>",e.sources.forEach((i,s)=>{const r=document.createElement("a");r.href=i.url,r.target="_blank",r.textContent=`[${s+1}] ${i.title}`,r.style.cssText=m.sourceLink,n.appendChild(r),n.appendChild(document.createElement("br"))}),o.appendChild(n)}t.appendChild(o),setTimeout(()=>{t.scrollTop=t.scrollHeight},10)}setRules(e,t){}clearMessages(){const e=this.panel.querySelector("#sm-messages");e&&(e.innerHTML="")}async showHistory(){try{const{DatabaseService:e}=await Promise.resolve().then(()=>f),t=await e.getConversations();this.showHistoryView(t)}catch(e){console.error("Failed to load history:",e),alert("載入歷史記錄失敗")}}showHistoryView(e){const t=this.panel.querySelector("#sm-chat-view");if(console.log("📋 showHistoryView called with",e.length,"conversations"),console.log("📋 chatView:",t),!t){console.error("❌ chatView not found");return}t.style.display="none";let o=this.panel.querySelector("#sm-history-view");if(!o){o=document.createElement("div"),o.id="sm-history-view",o.style.cssText=m.chatView;const s=t.parentElement;if(console.log("📋 parent element:",s),s)s.appendChild(o),console.log("✅ History view created and appended");else{console.error("❌ Parent element not found");return}}if(o.style.display="flex",o.style.flexDirection="column",console.log("✅ History view display set to flex"),!Array.isArray(e)||e.length===0)o.innerHTML=`
      ...
      `;else{const s=e.map(r=>{let a=[];try{a=typeof r.messages=="string"?JSON.parse(r.messages):r.messages}catch{a=[]}const c=Array.isArray(a)?a.length:0,h=new Date(r.created_at).toLocaleString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}),l=r.conversation_id||r.id||"unknown",d=l.toString().slice(-8);return`
    ...
    `}showEditDialog(e,t,o=!1){return new Promise(n=>{const i=document.createElement("div");i.style.cssText=`
      ...
      `,document.body.appendChild(i);const r=i.querySelector("#edit-input"),a=i.querySelector("#cancel-btn"),c=i.querySelector("#save-btn");r.focus(),r instanceof HTMLInputElement?r.select():r.setSelectionRange(0,r.value.length),a==null||a.addEventListener("click",()=>{document.body.removeChild(i),n(null)}),c==null||c.addEventListener("click",()=>{const h=r.value.trim();document.body.removeChild(i),n(h)}),r instanceof HTMLInputElement&&r.addEventListener("keydown",h=>{if(h.key==="Enter"){const l=r.value.trim();document.body.removeChild(i),n(l)}}),i.addEventListener("click",h=>{h.target===i&&(document.body.removeChild(i),n(null))})})}showConfirmDialog(e){return new Promise(t=>{var s,r;const o=document.createElement("div");o.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
      ...
      `,o.appendChild(n),document.body.appendChild(o);const i=a=>{document.body.removeChild(o),t(a)};(s=n.querySelector("#confirm-ok"))==null||s.addEventListener("click",()=>i(!0)),(r=n.querySelector("#confirm-cancel"))==null||r.addEventListener("click",()=>i(!1)),o.addEventListener("click",a=>{a.target===o&&i(!1)})})}showAlertDialog(e){return new Promise(t=>{var s;const o=document.createElement("div");o.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
      ...
      `,o.appendChild(n),document.body.appendChild(o);const i=()=>{document.body.removeChild(o),t()};(s=n.querySelector("#alert-ok"))==null||s.addEventListener("click",i),o.addEventListener("click",r=>{r.target===o&&i()})})}updateNavHighlight(){if(!this.container)return;this.container.querySelectorAll(".nav-item").forEach(t=>{const o=t,n=o.dataset.page===this.currentPage;o.style.background=n?"#ede9fe":"transparent",o.style.color=n?"#7c3aed":"#4b5563",o.style.fontWeight=n?"600":"500",n?o.classList.add("active"):o.classList.remove("active")})}bindEvents(){if(!this.container)return;const e=this.container.querySelector("#admin-login-form");if(e){e.addEventListener("submit",async d=>{d.preventDefault(),d.stopPropagation();const p=this.container.querySelector("#admin-username"),u=this.container.querySelector("#admin-password"),g=(p==null?void 0:p.value)||"",y=(u==null?void 0:u.value)||"";console.log("Login attempt with username:",g);try{const{DatabaseService:x}=await Promise.resolve().then(()=>f),v=await x.validateAdmin(g,y);console.log("Login successful (database auth)"),this.isAuthenticated=!0,this.container.innerHTML=this.renderAdminUI(),await this.updatePageContent(),this.bindEvents()}catch(x){console.error("Login error:",x),this.showAlertDialog("登入時發生錯誤，請稍後再試").then(()=>{u.value="",u.focus()})}});const l=this.container.querySelector("#admin-username");l&&setTimeout(()=>{l.focus()},100)}setTimeout(()=>{const l=this.container.querySelectorAll(".nav-item");if(console.log("Binding nav items, found:",l.length),l.length===0&&this.isAuthenticated){console.warn("Nav items not found, retrying..."),setTimeout(()=>this.bindEvents(),100);return}l.forEach((d,p)=>{console.log(`Binding nav item ${p}:`,d.dataset.page);const u=d.cloneNode(!0);d.parentNode.replaceChild(u,d),u.addEventListener("click",async()=>{const g=u.dataset.page;console.log("Nav item clicked:",g),g&&g!==this.currentPage&&(this.currentPage=g,await this.updatePageContent(),this.updateNavHighlight())})})},50);const t=this.container.querySelector("#admin-logout");t&&t.addEventListener("click",()=>{this.isAuthenticated=!1,this.container.innerHTML=this.renderLoginUI(),this.bindEvents()});const o=this.container.querySelector("#telegram-settings-form");o&&o.addEventListener("submit",async l=>{l.preventDefault(),l.stopPropagation();const d=this.container.querySelector("#telegram-enabled"),p=(d==null?void 0:d.checked)||!1;this.setTelegramEnabled(p),alert(`Telegram 通知已${p?"啟用":"停用"}`),await this.updatePageContent()});const n=this.container.querySelector("#change-password-form");n&&n.addEventListener("submit",async l=>{l.preventDefault(),l.stopPropagation();const d=this.container.querySelector("#new-password");if(((d==null?void 0:d.value)||"").length<4){alert("密碼長度至少 4 個字元");return}alert("密碼已更新"),await this.updatePageContent()});const i=this.container.querySelector("#ip-whitelist-form");i&&i.addEventListener("submit",async l=>{l.preventDefault(),l.stopPropagation();const d=this.container.querySelector("#ip-list"),u=((d==null?void 0:d.value)||"").split(`
`).map(g=>g.trim()).filter(g=>g.length>0);this.saveIPWhitelist(u),alert(`已更新 IP 白名單（${u.length} 個 IP）`),await this.updatePageContent()});const s=this.container.querySelector("#api-config-form");s&&s.addEventListener("submit",l=>{var d,p,u,g,y,x;l.preventDefault(),l.stopPropagation(),(d=this.container.querySelector("#llm-endpoint"))!=null&&d.value,(p=this.container.querySelector("#llm-api-key"))!=null&&p.value,(u=this.container.querySelector("#llm-deployment"))!=null&&u.value,(g=this.container.querySelector("#embed-endpoint"))!=null&&g.value,(y=this.container.querySelector("#embed-api-key"))!=null&&y.value,(x=this.container.querySelector("#embed-deployment"))!=null&&x.value,alert("API 設定已儲存")});const r=this.container.querySelector("#agent-tool-config-form");r&&r.addEventListener("submit",async l=>{var d,p;l.preventDefault(),l.stopPropagation(),(d=this.container.querySelector("#manual-index-enabled"))!=null&&d.checked,(p=this.container.querySelector("#frontend-pages-enabled"))!=null&&p.checked,alert("Agent 設定已儲存"),await this.updatePageContent()});const a=this.container.querySelector("#sql-plugin-config-form");a&&a.addEventListener("submit",async l=>{var E,L,P,q,D,M,T,_;l.preventDefault(),l.stopPropagation();const d=((E=this.container.querySelector("#sql-plugin-enabled"))==null?void 0:E.checked)||!1,p=parseInt(((L=this.container.querySelector("#sql-plugin-priority"))==null?void 0:L.value)||"5"),u=((P=this.container.querySelector("#sql-api-endpoint"))==null?void 0:P.value)||"",g=((q=this.container.querySelector("#sql-connection-id"))==null?void 0:q.value)||"",y=((D=this.container.querySelector("#sql-search-table"))==null?void 0:D.value)||"knowledge_base",x=((M=this.container.querySelector("#sql-title-column"))==null?void 0:M.value)||"title",v=((T=this.container.querySelector("#sql-content-column"))==null?void 0:T.value)||"content",z=((_=this.container.querySelector("#sql-url-column"))==null?void 0:_.value)||"url",B={enabled:d,priority:p,apiEndpoint:u,connectionId:g,searchTable:y,titleColumn:x,contentColumn:v,urlColumn:z};localStorage.setItem("sm_sql_plugin_config",JSON.stringify(B)),alert("SQL Plugin 設定已儲存"),await this.updatePageContent()});const c=this.container.querySelector("#sql-connection-form");c&&c.addEventListener("submit",async l=>{var p,u;l.preventDefault(),l.stopPropagation();const d=((p=this.container.querySelector("#sql-conn-name"))==null?void 0:p.value)||"";if((u=this.container.querySelector("#sql-conn-type"))==null||u.value,!d){alert("請輸入連接名稱");return}try{alert("SQL 連接已新增"),await this.updatePageContent()}catch(g){console.error("Error creating SQL connection:",g),alert("新增失敗")}}),this.container.querySelectorAll(".delete-sql-connection").forEach(l=>{l.addEventListener("click",async()=>{if(l.dataset.id&&confirm("確定要刪除這個連接嗎？"))try{alert("連接已刪除"),await this.updatePageContent()}catch(p){console.error("Error deleting SQL connection:",p),alert("刪除失敗")}})})}renderAdminUI(){return`
    ...
    `,document.body.appendChild(o);const n=o.querySelector("#edit-index-form"),i=o.querySelector("#cancel-edit-btn");n.addEventListener("submit",async s=>{s.preventDefault();const r=o.querySelector("#edit-index-name").value;o.querySelector("#edit-index-description").value;const a=o.querySelector("#edit-index-content").value;if(!r||!a){await this.showAlertDialog("請填寫名稱和內容");return}try{await k.update(e,{title:r,content:a,url:""}),await this.showAlertDialog("索引已更新"),document.body.removeChild(o),await this.updatePageContent()}catch(c){await this.showAlertDialog(`更新失敗：${c instanceof Error?c.message:"未知錯誤"}`)}}),i.addEventListener("click",()=>{document.body.removeChild(o)}),o.addEventListener("click",s=>{s.target===o&&document.body.removeChild(o)})}async showAddIndexModal(){const e=document.createElement("div");e.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
    ...
    `,document.body.appendChild(e);const t=e.querySelector("#add-index-form"),o=e.querySelector("#cancel-add-btn");t.addEventListener("submit",async n=>{n.preventDefault();const i=e.querySelector("#add-index-name").value;e.querySelector("#add-index-description").value;const s=e.querySelector("#add-index-url").value,r=e.querySelector("#add-index-content").value;if(!i||!r){await this.showAlertDialog("請填寫名稱和內容");return}try{await k.create({title:i,content:r,url:s||void 0}),await this.showAlertDialog("索引已新增"),document.body.removeChild(e),await this.updatePageContent()}catch(a){await this.showAlertDialog(`新增失敗：${a instanceof Error?a.message:"未知錯誤"}`)}}),o.addEventListener("click",()=>{document.body.removeChild(e)}),e.addEventListener("click",n=>{n.target===e&&document.body.removeChild(e)})}async showDeleteConfirmDialog(e){const t=await k.getById(e);if(!t){await this.showAlertDialog("找不到該索引");return}if(await this.showConfirmDialog(`確定要刪除索引「${t.title||t.name||"未命名"}」嗎？此操作無法復原。`))try{await k.delete(e),await this.showAlertDialog("索引已刪除"),await this.updatePageContent()}catch(n){await this.showAlertDialog(`刪除失敗：${n instanceof Error?n.message:"未知錯誤"}`)}}async renderConversations(){try{const{CustomerServiceManager:e}=await Promise.resolve().then(()=>A),t=await e.getAllConversations();return`
          ...
          `:`
            <div style="overflow-x: auto;">
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                  ${t.slice().reverse().map(o=>{const n=o.conversation_id||o.conversationId||o.id,i=o.user_id||o.userId||"undefined",s=Array.isArray(o.messages)?o.messages:[],r=o.status||"active",a=o.created_at||o.createdAt||o.startedAt;return`
      ...
      `}}async renderSystemSettings(){let e={},t=[];try{const{DatabaseService:i}=await Promise.resolve().then(()=>f),[s,r]=await Promise.all([i.getSettings().catch(()=>({})),i.getAdminUsers().catch(()=>[])]);e=s,t=r}catch(i){console.error("Failed to load system settings:",i)}const o=e.default_reply||"",n=e.system_prompt||"";return`
