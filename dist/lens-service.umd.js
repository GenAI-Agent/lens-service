(function(m,w){typeof exports=="object"&&typeof module<"u"?module.exports=w():typeof define=="function"&&define.amd?define(w):(m=typeof globalThis<"u"?globalThis:m||self,m.LensService=w())})(this,function(){"use strict";var N=Object.defineProperty;var Q=(m,w,C)=>w in m?N(m,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):m[w]=C;var b=(m,w,C)=>Q(m,typeof w!="symbol"?w+"":w,C);const m={container:`
  ...
  `};class w{constructor(e="33.33%",t="right"){b(this,"container");b(this,"overlay");b(this,"panel");b(this,"isOpen",!1);b(this,"width");b(this,"position");b(this,"capturedImage",null);b(this,"capturedText",null);b(this,"onSendMessage");b(this,"onSelectRule");b(this,"onClose");b(this,"onOpen");this.width=e,this.position=t,this.container=this.createContainer(),this.overlay=this.createOverlay(),this.panel=this.createPanel()}createContainer(){const e=document.createElement("div");return e.id="sm-container",e.style.cssText=m.container,e}createOverlay(){const e=document.createElement("div");return e.style.cssText=m.overlay,e.style.display="none",e.addEventListener("click",()=>this.close()),e}createPanel(){const e=document.createElement("div");return e.style.cssText=m.panel,e.style.width=this.width,this.position==="right"?(e.style.right=`-${this.width}`,e.style.left="auto"):(e.style.left=`-${this.width}`,e.style.right="auto"),e.innerHTML=`
    ...
    `}showEditDialog(e,t,o=!1){return new Promise(i=>{const n=document.createElement("div");n.style.cssText=`
      ...
      `,document.body.appendChild(n);const s=n.querySelector("#edit-input"),a=n.querySelector("#cancel-btn"),c=n.querySelector("#save-btn");s.focus(),s instanceof HTMLInputElement?s.select():s.setSelectionRange(0,s.value.length),a==null||a.addEventListener("click",()=>{document.body.removeChild(n),i(null)}),c==null||c.addEventListener("click",()=>{const h=s.value.trim();document.body.removeChild(n),i(h)}),s instanceof HTMLInputElement&&s.addEventListener("keydown",h=>{if(h.key==="Enter"){const l=s.value.trim();document.body.removeChild(n),i(l)}}),n.addEventListener("click",h=>{h.target===n&&(document.body.removeChild(n),i(null))})})}showConfirmDialog(e){return new Promise(t=>{var r,s;const o=document.createElement("div");o.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
...
`).map(g=>g.trim()).filter(g=>g.length>0);this.saveIPWhitelist(u),alert(`已更新 IP 白名單（${u.length} 個 IP）`),await this.updatePageContent()});const r=this.container.querySelector("#api-config-form");r&&r.addEventListener("submit",l=>{var d,p,u,g,y,x;l.preventDefault(),l.stopPropagation(),(d=this.container.querySelector("#llm-endpoint"))!=null&&d.value,(p=this.container.querySelector("#llm-api-key"))!=null&&p.value,(u=this.container.querySelector("#llm-deployment"))!=null&&u.value,(g=this.container.querySelector("#embed-endpoint"))!=null&&g.value,(y=this.container.querySelector("#embed-api-key"))!=null&&y.value,(x=this.container.querySelector("#embed-deployment"))!=null&&x.value,alert("API 設定已儲存")});const s=this.container.querySelector("#agent-tool-config-form");s&&s.addEventListener("submit",async l=>{var d,p;l.preventDefault(),l.stopPropagation(),(d=this.container.querySelector("#manual-index-enabled"))!=null&&d.checked,(p=this.container.querySelector("#frontend-pages-enabled"))!=null&&p.checked,alert("Agent 設定已儲存"),await this.updatePageContent()});const a=this.container.querySelector("#sql-plugin-config-form");a&&a.addEventListener("submit",async l=>{var E,L,P,q,D,M,T,_;l.preventDefault(),l.stopPropagation();const d=((E=this.container.querySelector("#sql-plugin-enabled"))==null?void 0:E.checked)||!1,p=parseInt(((L=this.container.querySelector("#sql-plugin-priority"))==null?void 0:L.value)||"5"),u=((P=this.container.querySelector("#sql-api-endpoint"))==null?void 0:P.value)||"",g=((q=this.container.querySelector("#sql-connection-id"))==null?void 0:q.value)||"",y=((D=this.container.querySelector("#sql-search-table"))==null?void 0:D.value)||"knowledge_base",x=((M=this.container.querySelector("#sql-title-column"))==null?void 0:M.value)||"title",v=((T=this.container.querySelector("#sql-content-column"))==null?void 0:T.value)||"content",z=((_=this.container.querySelector("#sql-url-column"))==null?void 0:_.value)||"url",B={enabled:d,priority:p,apiEndpoint:u,connectionId:g,searchTable:y,titleColumn:x,contentColumn:v,urlColumn:z};localStorage.setItem("sm_sql_plugin_config",JSON.stringify(B)),alert("SQL Plugin 設定已儲存"),await this.updatePageContent()});const c=this.container.querySelector("#sql-connection-form");c&&c.addEventListener("submit",async l=>{var p,u;l.preventDefault(),l.stopPropagation();const d=((p=this.container.querySelector("#sql-conn-name"))==null?void 0:p.value)||"";if((u=this.container.querySelector("#sql-conn-type"))==null||u.value,!d){alert("請輸入連接名稱");return}try{alert("SQL 連接已新增"),await this.updatePageContent()}catch(g){console.error("Error creating SQL connection:",g),alert("新增失敗")}}),this.container.querySelectorAll(".delete-sql-connection").forEach(l=>{l.addEventListener("click",async()=>{if(l.dataset.id&&confirm("確定要刪除這個連接嗎？"))try{alert("連接已刪除"),await this.updatePageContent()}catch(p){console.error("Error deleting SQL connection:",p),alert("刪除失敗")}})})}renderAdminUI(){return`
    ...
    `,document.body.appendChild(e);const t=e.querySelector("#add-index-form"),o=e.querySelector("#cancel-add-btn");t.addEventListener("submit",async i=>{i.preventDefault();const n=e.querySelector("#add-index-name").value;e.querySelector("#add-index-description").value;const r=e.querySelector("#add-index-url").value,s=e.querySelector("#add-index-content").value;if(!n||!s){await this.showAlertDialog("請填寫名稱和內容");return}try{await k.create({title:n,content:s,url:r||void 0}),await this.showAlertDialog("索引已新增"),document.body.removeChild(e),await this.updatePageContent()}catch(a){await this.showAlertDialog(`新增失敗：${a instanceof Error?a.message:"未知錯誤"}`)}}),o.addEventListener("click",()=>{document.body.removeChild(e)}),e.addEventListener("click",i=>{i.target===e&&document.body.removeChild(e)})}async showDeleteConfirmDialog(e){const t=await k.getById(e);if(!t){await this.showAlertDialog("找不到該索引");return}if(await this.showConfirmDialog(`確定要刪除索引「${t.title||t.name||"未命名"}」嗎？此操作無法復原。`))try{await k.delete(e),await this.showAlertDialog("索引已刪除"),await this.updatePageContent()}catch(i){await this.showAlertDialog(`刪除失敗：${i instanceof Error?i.message:"未知錯誤"}`)}}async renderConversations(){try{const{CustomerServiceManager:e}=await Promise.resolve().then(()=>A),t=await e.getAllConversations();return`
      ...
      `}}async renderSystemSettings(){var n,r;let e=[],t=[];try{const{DatabaseService:s}=await Promise.resolve().then(()=>f),[a,c]=await Promise.all([s.getSettings().catch(()=>[]),s.getAdminUsers().catch(()=>[])]);e=a,t=c}catch(s){console.error("Failed to load system settings:",s)}const o=((n=e.find(s=>s.key==="default_reply"))==null?void 0:n.value)||"",i=((r=e.find(s=>s.key==="system_prompt"))==null?void 0:r.value)||"";return`
