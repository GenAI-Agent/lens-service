(function(b,w){typeof exports=="object"&&typeof module<"u"?module.exports=w():typeof define=="function"&&define.amd?define(w):(b=typeof globalThis<"u"?globalThis:b||self,b.LensService=w())})(this,function(){"use strict";var V=Object.defineProperty;var K=(b,w,A)=>w in b?V(b,w,{enumerable:!0,configurable:!0,writable:!0,value:A}):b[w]=A;var m=(b,w,A)=>K(b,typeof w!="symbol"?w+"":w,A);const b={container:`
  ...
  `};class w{constructor(e="33.33%",t="right"){m(this,"container");m(this,"overlay");m(this,"panel");m(this,"isOpen",!1);m(this,"width");m(this,"position");m(this,"capturedImage",null);m(this,"capturedText",null);m(this,"onSendMessage");m(this,"onSelectRule");m(this,"onClose");m(this,"onOpen");this.width=e,this.position=t,this.container=this.createContainer(),this.overlay=this.createOverlay(),this.panel=this.createPanel()}createContainer(){const e=document.createElement("div");return e.id="sm-container",e.style.cssText=b.container,e}createOverlay(){const e=document.createElement("div");return e.style.cssText=b.overlay,e.style.display="none",e.addEventListener("click",()=>this.close()),e}createPanel(){const e=document.createElement("div");return e.style.cssText=b.panel,e.style.width=this.width,this.position==="right"?(e.style.right=`-${this.width}`,e.style.left="auto"):(e.style.left=`-${this.width}`,e.style.right="auto"),e.innerHTML=`
    ...
    `,this.bindEvents(e),e}bindEvents(e){var n,s,i,r,l;(n=e.querySelector("#sm-close-btn"))==null||n.addEventListener("click",()=>{this.close()});const t=e.querySelector("#sm-send-btn");t?(console.log("✅ Send button found, binding click event"),t.addEventListener("click",a=>{console.log("🔥 Send button clicked via addEventListener!"),a.preventDefault(),a.stopPropagation(),this.handleSend()}),t.onclick=a=>{console.log("🔥 Send button clicked via onclick!"),a.preventDefault(),a.stopPropagation(),this.handleSend()},e.addEventListener("click",a=>{(a.target.id==="sm-send-btn"||a.target.closest("#sm-send-btn"))&&(console.log("🔥 Send button clicked via delegation!"),a.preventDefault(),a.stopPropagation(),this.handleSend())})):console.error("❌ Send button not found!");const o=e.querySelector("#sm-input");o?(console.log("✅ Input field found, binding events"),o.addEventListener("keypress",a=>{a.key==="Enter"&&(console.log("🔥 Enter key pressed in input"),this.handleSend())}),o.addEventListener("input",a=>{console.log("🔥 Input event:",a.target.value)}),o.addEventListener("focus",()=>{console.log("🔥 Input focused")}),o.addEventListener("blur",()=>{console.log("🔥 Input blurred")})):console.error("❌ Input field not found!"),(s=e.querySelector("#sm-chat-tab"))==null||s.addEventListener("click",()=>{this.showView("chat")}),(i=e.querySelector("#sm-refresh-btn"))==null||i.addEventListener("click",()=>{this.clearMessages()}),(r=e.querySelector("#sm-history-btn"))==null||r.addEventListener("click",()=>{this.showHistory()}),(l=e.querySelector("#sm-remove-image"))==null||l.addEventListener("click",()=>{this.clearCapturedImage()})}handleSend(){const e=this.panel.querySelector("#sm-input"),t=e.value.trim();(t||this.capturedImage)&&this.onSendMessage&&(this.onSendMessage(t,this.capturedImage||void 0,this.capturedText||void 0),e.value="",this.clearCapturedImage())}showView(e){const t=this.panel.querySelector("#sm-chat-view"),o=this.panel.querySelector("#sm-chat-tab");e==="chat"&&(t.style.display="flex",o.style.cssText=b.tabButton+"; "+b.tabButtonActive)}addMessage(e){const t=this.panel.querySelector("#sm-messages");if(!t)return;const o=document.createElement("div");if(o.style.cssText=e.role==="user"?b.userMessage:b.assistantMessage,e.role==="assistant"?o.innerHTML=e.content:o.textContent=e.content,e.sources&&e.sources.length>0){const n=document.createElement("div");n.style.cssText=b.sources,n.innerHTML="<strong>參考來源：</strong><br>",e.sources.forEach((s,i)=>{const r=document.createElement("a");r.href=s.url,r.target="_blank",r.textContent=`[${i+1}] ${s.title}`,r.style.cssText=b.sourceLink,n.appendChild(r),n.appendChild(document.createElement("br"))}),o.appendChild(n)}t.appendChild(o),setTimeout(()=>{t.scrollTop=t.scrollHeight},10)}setRules(e,t){}clearMessages(){const e=this.panel.querySelector("#sm-messages");e&&(e.innerHTML="")}async showHistory(){try{const{DatabaseService:e}=await Promise.resolve().then(()=>v),t=await e.getConversations();this.showHistoryView(t)}catch(e){console.error("Failed to load history:",e),alert("載入歷史記錄失敗")}}showHistoryView(e){const t=this.panel.querySelector("#sm-chat-view");if(console.log("📋 showHistoryView called with",e.length,"conversations"),console.log("📋 chatView:",t),!t){console.error("❌ chatView not found");return}t.style.display="none";let o=this.panel.querySelector("#sm-history-view");if(!o){o=document.createElement("div"),o.id="sm-history-view",o.style.cssText=b.chatView;const i=t.parentElement;if(console.log("📋 parent element:",i),i)i.appendChild(o),console.log("✅ History view created and appended");else{console.error("❌ Parent element not found");return}}if(o.style.display="flex",o.style.flexDirection="column",console.log("✅ History view display set to flex"),!Array.isArray(e)||e.length===0)o.innerHTML=`
      ...
      `;else{const i=e.map(r=>{let l=[];try{l=typeof r.messages=="string"?JSON.parse(r.messages):r.messages}catch{l=[]}const a=Array.isArray(l)?l.length:0,p=new Date(r.created_at).toLocaleString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}),d=r.conversation_id||r.id||"unknown",c=d.toString().slice(-8);return`
    ...
    `}showEditDialog(e,t,o=!1){return new Promise(n=>{const s=document.createElement("div");s.style.cssText=`
      ...
      `,document.body.appendChild(s);const r=s.querySelector("#edit-input"),l=s.querySelector("#cancel-btn"),a=s.querySelector("#save-btn");r.focus(),r instanceof HTMLInputElement?r.select():r.setSelectionRange(0,r.value.length),l==null||l.addEventListener("click",()=>{document.body.removeChild(s),n(null)}),a==null||a.addEventListener("click",()=>{const p=r.value.trim();document.body.removeChild(s),n(p)}),r instanceof HTMLInputElement&&r.addEventListener("keydown",p=>{if(p.key==="Enter"){const d=r.value.trim();document.body.removeChild(s),n(d)}}),s.addEventListener("click",p=>{p.target===s&&(document.body.removeChild(s),n(null))})})}showConfirmDialog(e){return new Promise(t=>{var i,r;const o=document.createElement("div");o.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
      ...
      `,o.appendChild(n),document.body.appendChild(o);const s=()=>{document.body.removeChild(o),t()};(i=n.querySelector("#alert-ok"))==null||i.addEventListener("click",s),o.addEventListener("click",r=>{r.target===o&&s()})})}updateNavHighlight(){if(!this.container)return;this.container.querySelectorAll(".nav-item").forEach(t=>{const o=t,n=o.dataset.page===this.currentPage;o.style.background=n?"#ede9fe":"transparent",o.style.color=n?"#7c3aed":"#4b5563",o.style.fontWeight=n?"600":"500",n?o.classList.add("active"):o.classList.remove("active")})}bindEvents(){if(!this.container)return;const e=this.container.querySelector("#admin-login-form");if(e){e.addEventListener("submit",async c=>{c.preventDefault(),c.stopPropagation();const h=this.container.querySelector("#admin-username"),u=this.container.querySelector("#admin-password"),g=(h==null?void 0:h.value)||"",f=(u==null?void 0:u.value)||"";console.log("Login attempt with username:",g);try{const{DatabaseService:y}=await Promise.resolve().then(()=>v),S=await y.validateAdmin(g,f);console.log("Login successful (database auth)"),this.isAuthenticated=!0,this.container.innerHTML=this.renderAdminUI(),await this.updatePageContent(),this.bindEvents()}catch(y){console.error("Login error:",y),this.showAlertDialog("登入時發生錯誤，請稍後再試").then(()=>{u.value="",u.focus()})}});const d=this.container.querySelector("#admin-username");d&&setTimeout(()=>{d.focus()},100)}setTimeout(()=>{const d=this.container.querySelectorAll(".nav-item");if(console.log("Binding nav items, found:",d.length),d.length===0&&this.isAuthenticated){console.warn("Nav items not found, retrying..."),setTimeout(()=>this.bindEvents(),100);return}d.forEach((c,h)=>{console.log(`Binding nav item ${h}:`,c.dataset.page);const u=c.cloneNode(!0);c.parentNode.replaceChild(u,c),u.addEventListener("click",async()=>{const g=u.dataset.page;console.log("Nav item clicked:",g),g&&g!==this.currentPage&&(this.currentPage=g,await this.updatePageContent(),this.updateNavHighlight())})})},50);const t=this.container.querySelector("#admin-logout");t&&t.addEventListener("click",()=>{this.isAuthenticated=!1,this.container.innerHTML=this.renderLoginUI(),this.bindEvents()});const o=this.container.querySelector("#telegram-settings-form");o&&o.addEventListener("submit",async d=>{d.preventDefault(),d.stopPropagation();const c=this.container.querySelector("#telegram-enabled"),h=(c==null?void 0:c.checked)||!1;this.setTelegramEnabled(h),alert(`Telegram 通知已${h?"啟用":"停用"}`),await this.updatePageContent()});const n=this.container.querySelector("#change-password-form");n&&n.addEventListener("submit",async d=>{d.preventDefault(),d.stopPropagation();const c=this.container.querySelector("#new-password");if(((c==null?void 0:c.value)||"").length<4){alert("密碼長度至少 4 個字元");return}alert("密碼已更新"),await this.updatePageContent()});const s=this.container.querySelector("#ip-whitelist-form");s&&s.addEventListener("submit",async d=>{d.preventDefault(),d.stopPropagation();const c=this.container.querySelector("#ip-list"),u=((c==null?void 0:c.value)||"").split(`
`).map(g=>g.trim()).filter(g=>g.length>0);this.saveIPWhitelist(u),alert(`已更新 IP 白名單（${u.length} 個 IP）`),await this.updatePageContent()});const i=this.container.querySelector("#api-config-form");i&&i.addEventListener("submit",d=>{var c,h,u,g,f,y;d.preventDefault(),d.stopPropagation(),(c=this.container.querySelector("#llm-endpoint"))!=null&&c.value,(h=this.container.querySelector("#llm-api-key"))!=null&&h.value,(u=this.container.querySelector("#llm-deployment"))!=null&&u.value,(g=this.container.querySelector("#embed-endpoint"))!=null&&g.value,(f=this.container.querySelector("#embed-api-key"))!=null&&f.value,(y=this.container.querySelector("#embed-deployment"))!=null&&y.value,alert("API 設定已儲存")});const r=this.container.querySelector("#agent-tool-config-form");r&&r.addEventListener("submit",async d=>{var c,h;d.preventDefault(),d.stopPropagation(),(c=this.container.querySelector("#manual-index-enabled"))!=null&&c.checked,(h=this.container.querySelector("#frontend-pages-enabled"))!=null&&h.checked,alert("Agent 設定已儲存"),await this.updatePageContent()});const l=this.container.querySelector("#sql-plugin-config-form");l&&l.addEventListener("submit",async d=>{var x,q,M,D,T,_,O,j;d.preventDefault(),d.stopPropagation();const c=((x=this.container.querySelector("#sql-plugin-enabled"))==null?void 0:x.checked)||!1,h=parseInt(((q=this.container.querySelector("#sql-plugin-priority"))==null?void 0:q.value)||"5"),u=((M=this.container.querySelector("#sql-api-endpoint"))==null?void 0:M.value)||"",g=((D=this.container.querySelector("#sql-connection-id"))==null?void 0:D.value)||"",f=((T=this.container.querySelector("#sql-search-table"))==null?void 0:T.value)||"knowledge_base",y=((_=this.container.querySelector("#sql-title-column"))==null?void 0:_.value)||"title",S=((O=this.container.querySelector("#sql-content-column"))==null?void 0:O.value)||"content",z=((j=this.container.querySelector("#sql-url-column"))==null?void 0:j.value)||"url",P={enabled:c,priority:h,apiEndpoint:u,connectionId:g,searchTable:f,titleColumn:y,contentColumn:S,urlColumn:z};localStorage.setItem("sm_sql_plugin_config",JSON.stringify(P)),alert("SQL Plugin 設定已儲存"),await this.updatePageContent()});const a=this.container.querySelector("#sql-connection-form");a&&a.addEventListener("submit",async d=>{var h,u;d.preventDefault(),d.stopPropagation();const c=((h=this.container.querySelector("#sql-conn-name"))==null?void 0:h.value)||"";if((u=this.container.querySelector("#sql-conn-type"))==null||u.value,!c){alert("請輸入連接名稱");return}try{alert("SQL 連接已新增"),await this.updatePageContent()}catch(g){console.error("Error creating SQL connection:",g),alert("新增失敗")}}),this.container.querySelectorAll(".delete-sql-connection").forEach(d=>{d.addEventListener("click",async()=>{if(d.dataset.id&&confirm("確定要刪除這個連接嗎？"))try{alert("連接已刪除"),await this.updatePageContent()}catch(h){console.error("Error deleting SQL connection:",h),alert("刪除失敗")}})})}renderAdminUI(){return`
          ...
          <div style="margin-bottom: 24px;">
            ...
            <div style="margin-bottom: 16px;">
              ...
              <input
                ...
                name="embedApiKey"
                placeholder="your-api-key"
                value="${((d=e.embeddingAPI)==null?void 0:d.apiKey)||((c=e.azureOpenAI)==null?void 0:c.apiKey)||""}"
                style="width: 100%; padding: 10px 14px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px; box-sizing: border-box; background: white; color: #1f2937;"
              />
            </div>
