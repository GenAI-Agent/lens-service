(function(g,v){typeof exports=="object"&&typeof module<"u"?module.exports=v():typeof define=="function"&&define.amd?define(v):(g=typeof globalThis<"u"?globalThis:g||self,g.LensService=v())})(this,function(){"use strict";var R=Object.defineProperty;var N=(g,v,C)=>v in g?R(g,v,{enumerable:!0,configurable:!0,writable:!0,value:C}):g[v]=C;var b=(g,v,C)=>N(g,typeof v!="symbol"?v+"":v,C);const g={container:`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
  ...
  `,tabButtonActive:`
    ...
    color: white;
    border-color: #6366f1;
  `};class v{constructor(e="33.33%",t="right"){b(this,"container");b(this,"overlay");b(this,"panel");b(this,"isOpen",!1);b(this,"width");b(this,"position");b(this,"capturedImage",null);b(this,"capturedText",null);b(this,"onSendMessage");b(this,"onSelectRule");b(this,"onClose");b(this,"onOpen");this.width=e,this.position=t,this.container=this.createContainer(),this.overlay=this.createOverlay(),this.panel=this.createPanel()}createContainer(){const e=document.createElement("div");return e.id="sm-container",e.style.cssText=g.container,e}createOverlay(){const e=document.createElement("div");return e.style.cssText=g.overlay,e.style.display="none",e.addEventListener("click",()=>this.close()),e}createPanel(){const e=document.createElement("div");return e.style.cssText=g.panel,e.style.width=this.width,this.position==="right"?(e.style.right=`-${this.width}`,e.style.left="auto"):(e.style.left=`-${this.width}`,e.style.right="auto"),e.innerHTML=`
      <div id="sm-view-container" style="${g.viewContainer}">
        <!-- 右上角工具按鈕 -->
        <div style="position: absolute; top: 16px; right: 16px; display: flex; gap: 6px; z-index: 10;">

          <button id="sm-history-btn" style="${g.iconButton}" title="歷史記錄">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
          </button>
          <button id="sm-refresh-btn" style="${g.iconButton}" title="刷新">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M21.5 2v6h-6M2.5 22v-6h6M2 11.5a10 10 0 0118.8-4.3M22 12.5a10 10 0 01-18.8 4.2"/>
            </svg>
          </button>
          <button id="sm-close-btn" style="${g.iconButton}" title="關閉">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- 對話視圖 -->
        <div id="sm-chat-view" style="${g.chatView}">
          <div id="sm-messages" style="${g.messagesContainer}"></div>
          <div style="${g.inputContainer}">
            <!-- 圖片預覽（預設隱藏） -->
            ...
            <div style="position: relative; width: 100%;">
              <input
                ...
                style="${g.input}"
              />
              <button id="sm-send-btn" style="${g.sendIconButton}" title="發送">
    ...
    `,this.bindEvents(e),e}bindEvents(e){var i,n,r,s,a;(i=e.querySelector("#sm-close-btn"))==null||i.addEventListener("click",()=>{this.close()});const t=e.querySelector("#sm-send-btn");t?(console.log("✅ Send button found, binding click event"),t.addEventListener("click",d=>{console.log("🔥 Send button clicked via addEventListener!"),d.preventDefault(),d.stopPropagation(),this.handleSend()}),t.onclick=d=>{console.log("🔥 Send button clicked via onclick!"),d.preventDefault(),d.stopPropagation(),this.handleSend()},e.addEventListener("click",d=>{(d.target.id==="sm-send-btn"||d.target.closest("#sm-send-btn"))&&(console.log("🔥 Send button clicked via delegation!"),d.preventDefault(),d.stopPropagation(),this.handleSend())})):console.error("❌ Send button not found!");const o=e.querySelector("#sm-input");o?(console.log("✅ Input field found, binding events"),o.addEventListener("keypress",d=>{d.key==="Enter"&&(console.log("🔥 Enter key pressed in input"),this.handleSend())}),o.addEventListener("input",d=>{console.log("🔥 Input event:",d.target.value)}),o.addEventListener("focus",()=>{console.log("🔥 Input focused")}),o.addEventListener("blur",()=>{console.log("🔥 Input blurred")})):console.error("❌ Input field not found!"),(n=e.querySelector("#sm-chat-tab"))==null||n.addEventListener("click",()=>{this.showView("chat")}),(r=e.querySelector("#sm-refresh-btn"))==null||r.addEventListener("click",()=>{this.clearMessages()}),(s=e.querySelector("#sm-history-btn"))==null||s.addEventListener("click",()=>{this.showHistory()}),(a=e.querySelector("#sm-remove-image"))==null||a.addEventListener("click",()=>{this.clearCapturedImage()})}handleSend(){const e=this.panel.querySelector("#sm-input"),t=e.value.trim();(t||this.capturedImage)&&this.onSendMessage&&(this.onSendMessage(t,this.capturedImage||void 0,this.capturedText||void 0),e.value="",this.clearCapturedImage())}showView(e){const t=this.panel.querySelector("#sm-chat-view"),o=this.panel.querySelector("#sm-chat-tab");e==="chat"&&(t.style.display="flex",o.style.cssText=g.tabButton+"; "+g.tabButtonActive)}addMessage(e){const t=this.panel.querySelector("#sm-messages");if(!t)return;const o=document.createElement("div");if(o.style.cssText=e.role==="user"?g.userMessage:g.assistantMessage,e.role==="assistant"?o.innerHTML=e.content:o.textContent=e.content,e.sources&&e.sources.length>0){const i=document.createElement("div");i.style.cssText=g.sources,i.innerHTML="<strong>參考來源：</strong><br>",e.sources.forEach((n,r)=>{const s=document.createElement("a");s.href=n.url,s.target="_blank",s.textContent=`[${r+1}] ${n.title}`,s.style.cssText=g.sourceLink,i.appendChild(s),i.appendChild(document.createElement("br"))}),o.appendChild(i)}t.appendChild(o),setTimeout(()=>{t.scrollTop=t.scrollHeight},10)}setRules(e,t){}clearMessages(){const e=this.panel.querySelector("#sm-messages");e&&(e.innerHTML="")}async showHistory(){try{const{DatabaseService:e}=await Promise.resolve().then(()=>f),t=await e.getConversations();this.showHistoryView(t)}catch(e){console.error("Failed to load history:",e),alert("載入歷史記錄失敗")}}showHistoryView(e){var s;const t=this.panel.querySelector("#sm-chat-view"),o=this.panel.querySelector("#sm-chat-tab");if(!t||!o)return;t.style.display="none",o.style.cssText=g.tabButton;let i=this.panel.querySelector("#sm-history-view");if(i||(i=document.createElement("div"),i.id="sm-history-view",i.style.cssText=g.chatView,(s=t.parentElement)==null||s.appendChild(i)),i.style.display="flex",!Array.isArray(e)||e.length===0)i.innerHTML=`
      ...
      `;else{const a=e.map(d=>{let h=[];try{h=typeof d.messages=="string"?JSON.parse(d.messages):d.messages}catch{h=[]}const l=Array.isArray(h)?h.length:0,c=new Date(d.created_at).toLocaleString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"});return`
    ...
    `}showEditDialog(e,t,o=!1){return new Promise(i=>{const n=document.createElement("div");n.style.cssText=`
      ...
      `,o.appendChild(i),document.body.appendChild(o);const n=()=>{document.body.removeChild(o),t()};(r=i.querySelector("#alert-ok"))==null||r.addEventListener("click",n),o.addEventListener("click",s=>{s.target===o&&n()})})}updateNavHighlight(){if(!this.container)return;this.container.querySelectorAll(".nav-item").forEach(t=>{const o=t,i=o.dataset.page===this.currentPage;o.style.background=i?"#ede9fe":"transparent",o.style.color=i?"#7c3aed":"#4b5563",o.style.fontWeight=i?"600":"500",i?o.classList.add("active"):o.classList.remove("active")})}bindEvents(){if(!this.container)return;const e=this.container.querySelector("#admin-login-form");if(e){e.addEventListener("submit",async c=>{c.preventDefault(),c.stopPropagation();const p=this.container.querySelector("#admin-username"),u=this.container.querySelector("#admin-password"),m=(p==null?void 0:p.value)||"",y=(u==null?void 0:u.value)||"";console.log("Login attempt with username:",m);try{const{DatabaseService:x}=await Promise.resolve().then(()=>f),S=await x.validateAdmin(m,y);console.log("Login successful (database auth)"),this.isAuthenticated=!0,this.container.innerHTML=this.renderAdminUI(),await this.updatePageContent(),this.bindEvents()}catch(x){console.error("Login error:",x),this.showAlertDialog("登入時發生錯誤，請稍後再試").then(()=>{u.value="",u.focus()})}});const l=this.container.querySelector("#admin-username");l&&setTimeout(()=>{l.focus()},100)}setTimeout(()=>{const l=this.container.querySelectorAll(".nav-item");if(console.log("Binding nav items, found:",l.length),l.length===0&&this.isAuthenticated){console.warn("Nav items not found, retrying..."),setTimeout(()=>this.bindEvents(),100);return}l.forEach((c,p)=>{console.log(`Binding nav item ${p}:`,c.dataset.page);const u=c.cloneNode(!0);c.parentNode.replaceChild(u,c),u.addEventListener("click",async()=>{const m=u.dataset.page;console.log("Nav item clicked:",m),m&&m!==this.currentPage&&(this.currentPage=m,await this.updatePageContent(),this.updateNavHighlight())})})},50);const t=this.container.querySelector("#admin-logout");t&&t.addEventListener("click",()=>{this.isAuthenticated=!1,this.container.innerHTML=this.renderLoginUI(),this.bindEvents()});const o=this.container.querySelector("#telegram-settings-form");o&&o.addEventListener("submit",async l=>{l.preventDefault(),l.stopPropagation();const c=this.container.querySelector("#telegram-enabled"),p=(c==null?void 0:c.checked)||!1;this.setTelegramEnabled(p),alert(`Telegram 通知已${p?"啟用":"停用"}`),await this.updatePageContent()});const i=this.container.querySelector("#change-password-form");i&&i.addEventListener("submit",async l=>{l.preventDefault(),l.stopPropagation();const c=this.container.querySelector("#new-password");if(((c==null?void 0:c.value)||"").length<4){alert("密碼長度至少 4 個字元");return}alert("密碼已更新"),await this.updatePageContent()});const n=this.container.querySelector("#ip-whitelist-form");n&&n.addEventListener("submit",async l=>{l.preventDefault(),l.stopPropagation();const c=this.container.querySelector("#ip-list"),u=((c==null?void 0:c.value)||"").split(`
`).map(m=>m.trim()).filter(m=>m.length>0);this.saveIPWhitelist(u),alert(`已更新 IP 白名單（${u.length} 個 IP）`),await this.updatePageContent()});const r=this.container.querySelector("#api-config-form");r&&r.addEventListener("submit",l=>{var c,p,u,m,y,x;l.preventDefault(),l.stopPropagation(),(c=this.container.querySelector("#llm-endpoint"))!=null&&c.value,(p=this.container.querySelector("#llm-api-key"))!=null&&p.value,(u=this.container.querySelector("#llm-deployment"))!=null&&u.value,(m=this.container.querySelector("#embed-endpoint"))!=null&&m.value,(y=this.container.querySelector("#embed-api-key"))!=null&&y.value,(x=this.container.querySelector("#embed-deployment"))!=null&&x.value,alert("API 設定已儲存")});const s=this.container.querySelector("#agent-tool-config-form");s&&s.addEventListener("submit",async l=>{var c,p;l.preventDefault(),l.stopPropagation(),(c=this.container.querySelector("#manual-index-enabled"))!=null&&c.checked,(p=this.container.querySelector("#frontend-pages-enabled"))!=null&&p.checked,alert("Agent 設定已儲存"),await this.updatePageContent()});const a=this.container.querySelector("#sql-plugin-config-form");a&&a.addEventListener("submit",async l=>{var E,L,P,q,D,M,T,_;l.preventDefault(),l.stopPropagation();const c=((E=this.container.querySelector("#sql-plugin-enabled"))==null?void 0:E.checked)||!1,p=parseInt(((L=this.container.querySelector("#sql-plugin-priority"))==null?void 0:L.value)||"5"),u=((P=this.container.querySelector("#sql-api-endpoint"))==null?void 0:P.value)||"",m=((q=this.container.querySelector("#sql-connection-id"))==null?void 0:q.value)||"",y=((D=this.container.querySelector("#sql-search-table"))==null?void 0:D.value)||"knowledge_base",x=((M=this.container.querySelector("#sql-title-column"))==null?void 0:M.value)||"title",S=((T=this.container.querySelector("#sql-content-column"))==null?void 0:T.value)||"content",z=((_=this.container.querySelector("#sql-url-column"))==null?void 0:_.value)||"url",B={enabled:c,priority:p,apiEndpoint:u,connectionId:m,searchTable:y,titleColumn:x,contentColumn:S,urlColumn:z};localStorage.setItem("sm_sql_plugin_config",JSON.stringify(B)),alert("SQL Plugin 設定已儲存"),await this.updatePageContent()});const d=this.container.querySelector("#sql-connection-form");d&&d.addEventListener("submit",async l=>{var p,u;l.preventDefault(),l.stopPropagation();const c=((p=this.container.querySelector("#sql-conn-name"))==null?void 0:p.value)||"";if((u=this.container.querySelector("#sql-conn-type"))==null||u.value,!c){alert("請輸入連接名稱");return}try{alert("SQL 連接已新增"),await this.updatePageContent()}catch(m){console.error("Error creating SQL connection:",m),alert("新增失敗")}}),this.container.querySelectorAll(".delete-sql-connection").forEach(l=>{l.addEventListener("click",async()=>{if(l.dataset.id&&confirm("確定要刪除這個連接嗎？"))try{alert("連接已刪除"),await this.updatePageContent()}catch(p){console.error("Error deleting SQL connection:",p),alert("刪除失敗")}})})}renderAdminUI(){return`
    ...
    `,document.body.appendChild(e);const t=e.querySelector("#add-index-form"),o=e.querySelector("#cancel-add-btn");t.addEventListener("submit",async i=>{i.preventDefault();const n=e.querySelector("#add-index-name").value;e.querySelector("#add-index-description").value;const r=e.querySelector("#add-index-url").value,s=e.querySelector("#add-index-content").value;if(!n||!s){await this.showAlertDialog("請填寫名稱和內容");return}try{await k.create({title:n,content:s,url:r||void 0}),await this.showAlertDialog("索引已新增"),document.body.removeChild(e),await this.updatePageContent()}catch(a){await this.showAlertDialog(`新增失敗：${a instanceof Error?a.message:"未知錯誤"}`)}}),o.addEventListener("click",()=>{document.body.removeChild(e)}),e.addEventListener("click",i=>{i.target===e&&document.body.removeChild(e)})}async showDeleteConfirmDialog(e){const t=await k.getById(e);if(!t){await this.showAlertDialog("找不到該索引");return}if(await this.showConfirmDialog(`確定要刪除索引「${t.title||t.name||"未命名"}」嗎？此操作無法復原。`))try{await k.delete(e),await this.showAlertDialog("索引已刪除"),await this.updatePageContent()}catch(i){await this.showAlertDialog(`刪除失敗：${i instanceof Error?i.message:"未知錯誤"}`)}}async renderConversations(){try{const{CustomerServiceManager:e}=await Promise.resolve().then(()=>I),t=await e.getAllConversations();return`
      ...
      `}}async renderAdminUsers(){try{const{AdminUserManager:e}=await Promise.resolve().then(()=>U),t=await e.getAllAdminUsers();return`
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
    ...
    `,document.body.appendChild(e);const t=e.querySelector("#add-admin-user-form"),o=e.querySelector("#cancel-add-admin-btn");t.addEventListener("submit",async i=>{i.preventDefault();const n=e.querySelector("#add-admin-username").value,r=e.querySelector("#add-admin-password").value,s=e.querySelector("#add-admin-email").value;try{const{DatabaseService:a}=await Promise.resolve().then(()=>f);await a.createAdminUser(n,r,s),document.body.removeChild(e),await this.showAlertDialog("管理員帳號已新增"),await this.updatePageContent()}catch(a){await this.showAlertDialog(`新增失敗：${a instanceof Error?a.message:"未知錯誤"}`)}}),o.addEventListener("click",()=>{document.body.removeChild(e)}),e.addEventListener("click",i=>{i.target===e&&document.body.removeChild(e)})}async showConversationModal(e){try{const{CustomerServiceManager:t}=await Promise.resolve().then(()=>I),o=await t.getConversationById(e);if(!o){await this.showAlertDialog("找不到該對話記錄");return}const i=o.conversation_id||o.conversationId||o.id,n=o.user_id||o.userId||"undefined",r=Array.isArray(o.messages)?o.messages:[],s=o.status||"active",a=o.created_at||o.createdAt,d=o.updated_at||o.updatedAt,h=document.createElement("div");h.style.cssText=`
      ...
      `,document.body.appendChild(h);const l=h.querySelector("#close-conversation-modal"),c=h.querySelector("#close-conversation-modal-btn"),p=h.querySelector("#send-customer-service-reply"),u=h.querySelector("#customer-service-reply"),m=()=>{document.body.removeChild(h)};l==null||l.addEventListener("click",m),c==null||c.addEventListener("click",m),p==null||p.addEventListener("click",async()=>{const y=u==null?void 0:u.value.trim();if(!y){await this.showAlertDialog("請輸入回覆內容");return}try{const{CustomerServiceManager:x}=await Promise.resolve().then(()=>I);await x.addCustomerServiceReply(e,y,"客服")?(await this.showAlertDialog("回覆已發送"),m(),await this.updatePageContent()):await this.showAlertDialog("發送失敗，請稍後再試")}catch(x){console.error("Failed to send reply:",x),await this.showAlertDialog(`發送失敗：${x instanceof Error?x.message:"未知錯誤"}`)}}),h.addEventListener("click",y=>{y.target===h&&m()})}catch(t){console.error("Error showing conversation modal:",t),await this.showAlertDialog("載入對話詳情失敗")}}}class j{constructor(){b(this,"config");b(this,"panel");b(this,"conversationState");b(this,"initialized",!1);b(this,"captureMode",!1);b(this,"adminPanel");b(this,"floatingIcon");b(this,"screenshotMode",!1);b(this,"hoverHandler",null);b(this,"mouseLeaveHandler",null)}async loadRulesFromSQL(){try{const e=await fetch("http://localhost:3002/rules");if(!e.ok)return console.log("No rules found in database, using empty array"),[];const t=await e.json();return Array.isArray(t)?t:[]}catch(e){return console.error("Failed to load rules from SQL:",e),[]}}async init(e){var o,i,n;if(this.initialized){console.warn("ServiceModuler already initialized");return}this.config=e,console.log("✅ Widget initializing");const t=e.telegram&&e.telegram.botToken&&e.telegram.chatId?e.telegram:void 0;window.SM_TELEGRAM_CONFIG=t,await this.loadRulesFromSQL(),this.panel=new v(((o=e.ui)==null?void 0:o.width)||"33.33%",((i=e.ui)==null?void 0:i.position)||"right"),this.panel.setCallbacks({onSendMessage:(r,s)=>this.handleSendMessage(r,s),onSelectRule:r=>this.handleSelectRule(r),onClose:()=>this.handleClose(),onOpen:()=>this.handleOpen()}),await this.loadConversationState(),this.adminPanel||(this.adminPanel=new O),window.location.pathname==="/lens-service"&&this.openAdminPanel(),this.bindGlobalKeyboardShortcuts(),((n=e.ui)==null?void 0:n.iconPosition)!==!1&&!this.isAdminPage()&&this.createFloatingIcon(),this.initialized=!0,e.debug&&console.log("ServiceModuler initialized",e)}bindGlobalKeyboardShortcuts(){document.addEventListener("keydown",e=>{var t,o;e.key&&e.key.toLowerCase()==="q"&&((t=this.panel)!=null&&t.isPanelOpen())?(console.log("🎯 Q key pressed, panel is open, enabling screenshot mode"),this.enableScreenshotMode()):e.key&&e.key.toLowerCase()==="q"&&console.log("🎯 Q key pressed, but panel is not open:",(o=this.panel)==null?void 0:o.isPanelOpen())}),document.addEventListener("keyup",e=>{e.key&&e.key.toLowerCase()==="q"&&this.disableScreenshotMode()}),document.addEventListener("click",e=>{var t;this.screenshotMode&&((t=this.panel)!=null&&t.isPanelOpen())&&(console.log("📸 Screenshot click detected"),e.preventDefault(),e.stopPropagation(),this.captureElementScreenshot(e.target))},!0)}open(){var e;if(!this.initialized){console.error("ServiceModuler not initialized. Call init() first.");return}(e=this.panel)==null||e.open()}close(){var e;(e=this.panel)==null||e.close()}async sendMessage(e,t){var i,n,r;if(!this.initialized||!this.panel){console.error("ServiceModuler not initialized");return}const o={role:"user",content:e||"請分析這張圖片",timestamp:Date.now()};(i=this.conversationState)==null||i.messages.push(o),this.panel.addMessage(o),this.saveConversationState();try{let s,a,d=!1;const h=((n=this.conversationState)==null?void 0:n.sessionId)||this.generateSessionId(),l=localStorage.getItem("lens_service_user_id")||"default_user";if(t)s=await this.processImageMessage(e,t);else{const p=await this.processTextMessage(e,h,l);s=p.response,a=p.sources,d=p.needsHumanReply,d&&await this.sendTelegramNotification(e,h)}const c={role:"assistant",content:s,timestamp:Date.now(),sources:a};(r=this.conversationState)==null||r.messages.push(c),this.panel.addMessage(c),this.saveConversationState(),await this.saveConversationToDatabase(h,l)}catch(s){console.error("Error processing message:",s);const a={role:"assistant",content:`抱歉，發生錯誤：${s instanceof Error?s.message:"未知錯誤"}`,timestamp:Date.now()};this.panel.addMessage(a)}}async processTextMessage(e,t,o){var i,n,r,s;try{const{DatabaseService:a}=await Promise.resolve().then(()=>f);await a.initializePool();const d=await a.getSetting("system_prompt")||"你是一個專業的客服助手，請用繁體中文回答問題。";return!((n=(i=this.config)==null?void 0:i.azureOpenAI)!=null&&n.endpoint)||!((s=(r=this.config)==null?void 0:r.azureOpenAI)!=null&&s.apiKey)?(console.warn("Azure OpenAI not configured, using default reply"),{response:await a.getSetting("default_reply")||"很抱歉，我無法回答這個問題。請聯繫人工客服獲得更多幫助。",sources:[],needsHumanReply:!0}):{response:await this.callAzureOpenAI(e,d),sources:[],needsHumanReply:!1}}catch(a){console.error("Error processing text message:",a);try{const{DatabaseService:d}=await Promise.resolve().then(()=>f);return{response:await d.getSetting("default_reply")||"很抱歉，我無法回答這個問題。請聯繫人工客服獲得更多幫助。",sources:[],needsHumanReply:!0}}catch{return{response:"系統暫時無法回應，請稍後再試。",sources:[],needsHumanReply:!0}}}}async processImageMessage(e,t){var o,i,n,r;try{return!((i=(o=this.config)==null?void 0:o.azureOpenAI)!=null&&i.endpoint)||!((r=(n=this.config)==null?void 0:n.azureOpenAI)!=null&&r.apiKey)?"圖片分析功能需要配置 Azure OpenAI 服務。":await this.callAzureOpenAIVision(e,t)}catch(s){return console.error("Error processing image message:",s),"圖片分析失敗，請重試或聯繫客服。"}}async callAzureOpenAI(e,t){var h,l,c,p,u,m,y,x,S,z;const o=(l=(h=this.config)==null?void 0:h.azureOpenAI)==null?void 0:l.endpoint,i=(p=(c=this.config)==null?void 0:c.azureOpenAI)==null?void 0:p.apiKey,n=(m=(u=this.config)==null?void 0:u.azureOpenAI)==null?void 0:m.deployment,r=(x=(y=this.config)==null?void 0:y.azureOpenAI)==null?void 0:x.apiVersion,s=`${o}openai/deployments/${n}/chat/completions?api-version=${r}`,a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","api-key":i},body:JSON.stringify({messages:[{role:"system",content:t},{role:"user",content:e}],max_tokens:1e3,temperature:.7})});if(!a.ok)throw new Error(`Azure OpenAI API error: ${a.status} ${a.statusText}`);return((z=(S=(await a.json()).choices[0])==null?void 0:S.message)==null?void 0:z.content)||"抱歉，我無法生成回應。"}async callAzureOpenAIVision(e,t){var h,l,c,p,u,m,y,x,S,z;const o=(l=(h=this.config)==null?void 0:h.azureOpenAI)==null?void 0:l.endpoint,i=(p=(c=this.config)==null?void 0:c.azureOpenAI)==null?void 0:p.apiKey,n=(m=(u=this.config)==null?void 0:u.azureOpenAI)==null?void 0:m.deployment,r=(x=(y=this.config)==null?void 0:y.azureOpenAI)==null?void 0:x.apiVersion,s=`${o}openai/deployments/${n}/chat/completions?api-version=${r}`,a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json","api-key":i},body:JSON.stringify({messages:[{role:"user",content:[{type:"text",text:e||"請分析這張圖片"},{type:"image_url",image_url:{url:`data:image/jpeg;base64,${t}`}}]}],max_tokens:1e3,temperature:.7})});if(!a.ok)throw new Error(`Azure OpenAI Vision API error: ${a.status} ${a.statusText}`);return((z=(S=(await a.json()).choices[0])==null?void 0:S.message)==null?void 0:z.content)||"抱歉，我無法分析這張圖片。"}async sendTelegramNotification(e,t){var o,i,n,r;try{const s=(i=(o=this.config)==null?void 0:o.telegram)==null?void 0:i.botToken,a=(r=(n=this.config)==null?void 0:n.telegram)==null?void 0:r.chatId;if(!s||!a){console.warn("Telegram not configured, skipping notification");return}const d=`🔔 新的客服訊息需要人工回覆
