(function(b,w){typeof exports=="object"&&typeof module<"u"?module.exports=w():typeof define=="function"&&define.amd?define(w):(b=typeof globalThis<"u"?globalThis:b||self,b.LensService=w())})(this,function(){"use strict";var V=Object.defineProperty;var K=(b,w,A)=>w in b?V(b,w,{enumerable:!0,configurable:!0,writable:!0,value:A}):b[w]=A;var m=(b,w,A)=>K(b,typeof w!="symbol"?w+"":w,A);const b={container:`
  ...
  `};class w{constructor(e="33.33%",t="right"){m(this,"container");m(this,"overlay");m(this,"panel");m(this,"isOpen",!1);m(this,"width");m(this,"position");m(this,"capturedImage",null);m(this,"capturedText",null);m(this,"onSendMessage");m(this,"onSelectRule");m(this,"onClose");m(this,"onOpen");this.width=e,this.position=t,this.container=this.createContainer(),this.overlay=this.createOverlay(),this.panel=this.createPanel()}createContainer(){const e=document.createElement("div");return e.id="sm-container",e.style.cssText=b.container,e}createOverlay(){const e=document.createElement("div");return e.style.cssText=b.overlay,e.style.display="none",e.addEventListener("click",()=>this.close()),e}createPanel(){const e=document.createElement("div");return e.style.cssText=b.panel,e.style.width=this.width,this.position==="right"?(e.style.right=`-${this.width}`,e.style.left="auto"):(e.style.left=`-${this.width}`,e.style.right="auto"),e.innerHTML=`
    ...
    `,this.bindEvents(e),e}bindEvents(e){var n,s,i,r,a;(n=e.querySelector("#sm-close-btn"))==null||n.addEventListener("click",()=>{this.close()});const t=e.querySelector("#sm-send-btn");t?(console.log("✅ Send button found, binding click event"),t.addEventListener("click",d=>{console.log("🔥 Send button clicked via addEventListener!"),d.preventDefault(),d.stopPropagation(),this.handleSend()}),t.onclick=d=>{console.log("🔥 Send button clicked via onclick!"),d.preventDefault(),d.stopPropagation(),this.handleSend()},e.addEventListener("click",d=>{(d.target.id==="sm-send-btn"||d.target.closest("#sm-send-btn"))&&(console.log("🔥 Send button clicked via delegation!"),d.preventDefault(),d.stopPropagation(),this.handleSend())})):console.error("❌ Send button not found!");const o=e.querySelector("#sm-input");o?(console.log("✅ Input field found, binding events"),o.addEventListener("keypress",d=>{d.key==="Enter"&&(console.log("🔥 Enter key pressed in input"),this.handleSend())}),o.addEventListener("input",d=>{console.log("🔥 Input event:",d.target.value)}),o.addEventListener("focus",()=>{console.log("🔥 Input focused")}),o.addEventListener("blur",()=>{console.log("🔥 Input blurred")})):console.error("❌ Input field not found!"),(s=e.querySelector("#sm-chat-tab"))==null||s.addEventListener("click",()=>{this.showView("chat")}),(i=e.querySelector("#sm-refresh-btn"))==null||i.addEventListener("click",()=>{this.clearMessages()}),(r=e.querySelector("#sm-history-btn"))==null||r.addEventListener("click",()=>{this.showHistory()}),(a=e.querySelector("#sm-remove-image"))==null||a.addEventListener("click",()=>{this.clearCapturedImage()})}handleSend(){const e=this.panel.querySelector("#sm-input"),t=e.value.trim();(t||this.capturedImage)&&this.onSendMessage&&(this.onSendMessage(t,this.capturedImage||void 0,this.capturedText||void 0),e.value="",this.clearCapturedImage())}showView(e){const t=this.panel.querySelector("#sm-chat-view"),o=this.panel.querySelector("#sm-chat-tab");e==="chat"&&(t.style.display="flex",o.style.cssText=b.tabButton+"; "+b.tabButtonActive)}addMessage(e){const t=this.panel.querySelector("#sm-messages");if(!t)return;const o=document.createElement("div");if(o.style.cssText=e.role==="user"?b.userMessage:b.assistantMessage,e.role==="assistant"?o.innerHTML=e.content:o.textContent=e.content,e.sources&&e.sources.length>0){const n=document.createElement("div");n.style.cssText=b.sources,n.innerHTML="<strong>參考來源：</strong><br>",e.sources.forEach((s,i)=>{const r=document.createElement("a");r.href=s.url,r.target="_blank",r.textContent=`[${i+1}] ${s.title}`,r.style.cssText=b.sourceLink,n.appendChild(r),n.appendChild(document.createElement("br"))}),o.appendChild(n)}t.appendChild(o),setTimeout(()=>{t.scrollTop=t.scrollHeight},10)}setRules(e,t){}clearMessages(){const e=this.panel.querySelector("#sm-messages");e&&(e.innerHTML="")}async showHistory(){try{const{DatabaseService:e}=await Promise.resolve().then(()=>v),t=await e.getConversations();this.showHistoryView(t)}catch(e){console.error("Failed to load history:",e),alert("載入歷史記錄失敗")}}showHistoryView(e){const t=this.panel.querySelector("#sm-chat-view");if(console.log("📋 showHistoryView called with",e.length,"conversations"),console.log("📋 chatView:",t),!t){console.error("❌ chatView not found");return}t.style.display="none";let o=this.panel.querySelector("#sm-history-view");if(!o){o=document.createElement("div"),o.id="sm-history-view",o.style.cssText=b.chatView;const i=t.parentElement;if(console.log("📋 parent element:",i),i)i.appendChild(o),console.log("✅ History view created and appended");else{console.error("❌ Parent element not found");return}}if(o.style.display="flex",o.style.flexDirection="column",console.log("✅ History view display set to flex"),!Array.isArray(e)||e.length===0)o.innerHTML=`
      ...
      `;else{const i=e.map(r=>{let a=[];try{a=typeof r.messages=="string"?JSON.parse(r.messages):r.messages}catch{a=[]}const d=Array.isArray(a)?a.length:0,p=new Date(r.created_at).toLocaleString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}),l=r.conversation_id||r.id||"unknown",c=l.toString().slice(-8);return`
    ...
    `}showEditDialog(e,t,o=!1){return new Promise(n=>{const s=document.createElement("div");s.style.cssText=`
      ...
      `,document.body.appendChild(s);const r=s.querySelector("#edit-input"),a=s.querySelector("#cancel-btn"),d=s.querySelector("#save-btn");r.focus(),r instanceof HTMLInputElement?r.select():r.setSelectionRange(0,r.value.length),a==null||a.addEventListener("click",()=>{document.body.removeChild(s),n(null)}),d==null||d.addEventListener("click",()=>{const p=r.value.trim();document.body.removeChild(s),n(p)}),r instanceof HTMLInputElement&&r.addEventListener("keydown",p=>{if(p.key==="Enter"){const l=r.value.trim();document.body.removeChild(s),n(l)}}),s.addEventListener("click",p=>{p.target===s&&(document.body.removeChild(s),n(null))})})}showConfirmDialog(e){return new Promise(t=>{var i,r;const o=document.createElement("div");o.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
...
`).map(g=>g.trim()).filter(g=>g.length>0);this.saveIPWhitelist(u),alert(`已更新 IP 白名單（${u.length} 個 IP）`),await this.updatePageContent()});const i=this.container.querySelector("#api-config-form");i&&i.addEventListener("submit",l=>{var c,h,u,g,f,y;l.preventDefault(),l.stopPropagation(),(c=this.container.querySelector("#llm-endpoint"))!=null&&c.value,(h=this.container.querySelector("#llm-api-key"))!=null&&h.value,(u=this.container.querySelector("#llm-deployment"))!=null&&u.value,(g=this.container.querySelector("#embed-endpoint"))!=null&&g.value,(f=this.container.querySelector("#embed-api-key"))!=null&&f.value,(y=this.container.querySelector("#embed-deployment"))!=null&&y.value,alert("API 設定已儲存")});const r=this.container.querySelector("#agent-tool-config-form");r&&r.addEventListener("submit",async l=>{var c,h;l.preventDefault(),l.stopPropagation(),(c=this.container.querySelector("#manual-index-enabled"))!=null&&c.checked,(h=this.container.querySelector("#frontend-pages-enabled"))!=null&&h.checked,alert("Agent 設定已儲存"),await this.updatePageContent()});const a=this.container.querySelector("#sql-plugin-config-form");a&&a.addEventListener("submit",async l=>{var x,q,D,M,T,_,O,j;l.preventDefault(),l.stopPropagation();const c=((x=this.container.querySelector("#sql-plugin-enabled"))==null?void 0:x.checked)||!1,h=parseInt(((q=this.container.querySelector("#sql-plugin-priority"))==null?void 0:q.value)||"5"),u=((D=this.container.querySelector("#sql-api-endpoint"))==null?void 0:D.value)||"",g=((M=this.container.querySelector("#sql-connection-id"))==null?void 0:M.value)||"",f=((T=this.container.querySelector("#sql-search-table"))==null?void 0:T.value)||"knowledge_base",y=((_=this.container.querySelector("#sql-title-column"))==null?void 0:_.value)||"title",S=((O=this.container.querySelector("#sql-content-column"))==null?void 0:O.value)||"content",z=((j=this.container.querySelector("#sql-url-column"))==null?void 0:j.value)||"url",P={enabled:c,priority:h,apiEndpoint:u,connectionId:g,searchTable:f,titleColumn:y,contentColumn:S,urlColumn:z};localStorage.setItem("sm_sql_plugin_config",JSON.stringify(P)),alert("SQL Plugin 設定已儲存"),await this.updatePageContent()});const d=this.container.querySelector("#sql-connection-form");d&&d.addEventListener("submit",async l=>{var h,u;l.preventDefault(),l.stopPropagation();const c=((h=this.container.querySelector("#sql-conn-name"))==null?void 0:h.value)||"";if((u=this.container.querySelector("#sql-conn-type"))==null||u.value,!c){alert("請輸入連接名稱");return}try{alert("SQL 連接已新增"),await this.updatePageContent()}catch(g){console.error("Error creating SQL connection:",g),alert("新增失敗")}}),this.container.querySelectorAll(".delete-sql-connection").forEach(l=>{l.addEventListener("click",async()=>{if(l.dataset.id&&confirm("確定要刪除這個連接嗎？"))try{alert("連接已刪除"),await this.updatePageContent()}catch(h){console.error("Error deleting SQL connection:",h),alert("刪除失敗")}})})}renderAdminUI(){return`
    ...
    `,document.body.appendChild(o);const n=o.querySelector("#edit-index-form"),s=o.querySelector("#cancel-edit-btn");n.addEventListener("submit",async i=>{i.preventDefault();const r=o.querySelector("#edit-index-name").value,a=o.querySelector("#edit-index-description").value,d=o.querySelector("#edit-index-content").value;if(!r||!d){await this.showAlertDialog("請填寫名稱和內容");return}try{await C.update(e,{title:r,description:a,content:d,url:""}),await this.showAlertDialog("索引已更新"),document.body.removeChild(o),await this.updatePageContent()}catch(p){await this.showAlertDialog(`更新失敗：${p instanceof Error?p.message:"未知錯誤"}`)}}),s.addEventListener("click",()=>{document.body.removeChild(o)}),o.addEventListener("click",i=>{i.target===o&&document.body.removeChild(o)})}async showAddIndexModal(){const e=document.createElement("div");e.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
