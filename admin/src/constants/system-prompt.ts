...
2. **IMPORTANT**: After calling a tool, STOP your response. Do NOT continue outputting text or calling more tools unless they are closely related.
3. Wait for the tool result to come back in the next turn
4. When you receive tool results, analyze them and decide your next step
5. Work step-by-step: one action → wait for result → next action
